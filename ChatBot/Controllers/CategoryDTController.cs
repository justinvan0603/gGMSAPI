...
namespace ChatBot.Controllers
{
    ...
    public class CategoryDTController : Controller
    {
        private readonly gGMSContext _context;

        public CategoryDTController(gGMSContext context)
        {
        ...
        public async Task<IEnumerable<PrdCategoryDt>> Get(string searchString)
        {
            try
            {
                string cmd = $"dbo.PRD_CATEGORY_DT_Search @p_TOP = ''";
