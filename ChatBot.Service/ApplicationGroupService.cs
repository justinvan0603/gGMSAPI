...
namespace ChatBot.Service
{
    public interface IApplicationGroupService
    {
        ...
        EntityEntry<ApplicationGroup> Add(ApplicationGroup appGroup);

        void Update(ApplicationGroup appGroup);

        EntityEntry<ApplicationGroup> Delete(int id);
    ...
    public class ApplicationGroupService : IApplicationGroupService
    {
        ...
        public EntityEntry<ApplicationGroup> Delete(int id)
        {
